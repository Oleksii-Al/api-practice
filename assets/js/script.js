const API_KEY = "-mCoQMZ_UJnaGvEjqknrLdI0eIM";
...
function displayStatus(data) {
    ...
    resultsContent.innerHTML = `<div>Your key is valid until</div>`
    resultsContent.innerHTML += `<div class="key-status">${data.expiry}</div>`;
